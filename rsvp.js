...
function brand(){
  return '<div class="rsvp-brand"><img src="https://magiadosim.github.io/magia-do-sim/assets/logo-oficial.png" alt="A Magia do Sim"><strong>A Magia do Sim</strong></div>';
}
function hero(){
