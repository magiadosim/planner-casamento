-- MAGIA PARA TODOS — LISTA DE PRESENTES V4.2
-- Exibe o valor de referência do presente na lista pública.
-- Continua sem expor pagamentos, observações ou demais dados privados.
